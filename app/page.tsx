          ...
          <SurfaceCard className="bg-[linear-gradient(145deg,rgba(255,255,255,0.94),rgba(225,236,251,0.88))]">
            <div className="space-y-4">
              ...
              <div className="flex items-end justify-between gap-4">
                ...
                <div className="w-28 rounded-[16px] border border-[var(--line)] bg-white/85 p-3 text-center shadow-[0_8px_18px_var(--shadow)]">
            ...
            <div className="space-y-5">
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                {(["CRITICAL", "HIGH", "MEDIUM"] as const).map((severity) => (
                  <div className="rounded-2xl border border-[var(--line)] bg-white/80 p-5" key={severity}>
                    <div className="flex items-center justify-between gap-3">
              ...
              <div className="rounded-[16px] border border-[var(--line)] bg-[var(--paper)]/85 p-5">
                ...
                <div className="mt-4 space-y-3">
                  {topFailures.map((failure) => (
                    <div
                      className="rounded-xl border border-[var(--line)] bg-white/75 px-4 py-4"
          ...
          <SurfaceCard>
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              {Object.entries((reportData?.architecture as Record<string, string> | undefined) ?? {}).map(
                ([key, value]) => (
                  <div className="rounded-xl border border-[var(--line)] bg-white/75 p-4" key={key}>
          ...
          <SurfaceCard>
            ...
            {attribution.attributions?.[0] ? (
              <div className="mt-5 space-y-4">
                ...
                <div className="rounded-xl border border-[var(--line)] bg-white/75 p-4">
          ...
          {[
            {
              href: "/contracts",
              label: "Contracts",
              detail: "Review contract coverage, risky fields, and subscribed consumers.",
            },
            {
              href: "/validations",
              label: "Validations",
              detail: "Compare clean and violated runs, modes, and decisions.",
            },
            {
              href: "/attribution",
              label: "Attribution",
              detail: "Review registry-first blast radius and ranked blame evidence.",
            },
            {
              href: "/report",
              label: "Report",
              detail: "Use the client-facing summary during a walkthrough.",
            },
          ].map((item) => (
            <Link
              className="rounded-xl border border-[var(--line)] bg-white/70 px-4 py-4 transition-colors hover:border-[var(--accent)] hover:bg-white/90"
              href={item.href}
              key={item.href}
            >
